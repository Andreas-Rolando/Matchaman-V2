...
import { MapPin, Clock, Gauge, Utensils, ShoppingBag, ChevronRight, Navigation } from 'lucide-react';
import { Branch, SalesMode } from '../types';
    ...
    <div className="mx-auto w-full max-w-3xl pb-32">
      ...
      <div className="mt-6 px-4">
        ...
        <div className="mt-3 flex flex-col gap-3 md:grid md:grid-cols-2">
          {/* Dine-in Option */}
          <button
            onClick={() => handleServiceClick('dine_in')}
          ...
          >
            <div className="mr-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-[#4b6f44] text-white shadow-sm transition-transform group-hover:scale-105">
            ...
            <div className="flex-grow">
              ...
              <p className="text-xs text-[#5d5f5b]">
                Experience the tranquility in our lounge
              </p>
            </div>
          ...
          {/* Takeaway Option */}
          <button
            onClick={() => handleServiceClick('takeaway')}
            className={`group flex items-center rounded-xl border-2 p-4 text-left transition-all active:scale-[0.98] ${
              salesMode === 'takeaway'
                ? 'border-[#34562e] bg-[#c7f0bb]/20 shadow-md'
                : 'border-transparent bg-white shadow-sm hover:border-[#34562e]/30'
          ...
          >
            <div className="mr-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-[#e0e0db] text-[#42483f] shadow-sm transition-transform group-hover:scale-105">
